...
// Inicializa a etapa atual da votação
...
// Atualiza interface de acordo com número digitado
...
// Corrige o voto atual
function corrige() {
    comecarEtapa();
}

// Confirma o voto e avança para próxima etapa
function confirma() {
    let etapa = etapas[etapaAtual];
